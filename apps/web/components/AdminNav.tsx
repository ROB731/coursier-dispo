...
const LIENS = [
  ...
  { href: "/admin/employes", label: "Employés", roles: ["SUPER_ADMIN"] as Role[] },
  { href: "/admin/presences", label: "Présences", roles: ["SUPER_ADMIN"] as Role[] },
  { href: "/admin/comptes", label: "Comptes", roles: ["SUPER_ADMIN", "DIRECTEUR"] as Role[] },
  { href: "/admin/sites", label: "Sites", roles: ["SUPER_ADMIN"] as Role[] },
